...
const ledgers = [
  { id: "personal", label: "Personal", icon: Home01Icon },
  { id: "business", label: "Negocio", icon: Store01Icon },
];
          ...
          <div className="flex flex-col items-center justify-center h-full px-6 pb-4">
            <div className="flex flex-col items-center gap-3 mb-8">
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-muted-foreground/70 mt-1.5 max-w-56 mx-auto leading-relaxed">
            ...
            <div className="relative">
              ...
              >
                <div className="w-5 h-5 rounded-full bg-primary/10 flex items-center justify-center">
                  <HugeiconsIcon
                    icon={ledgers[activeLedger].icon}
                    size={11}
                    className="text-primary"
                    strokeWidth={1.5}
                  />
              ...
              {ledgerOpen && (
                <div className="absolute bottom-full left-0 mb-1.5 bg-white/90 backdrop-blur-xl rounded-lg shadow-[0_4px_20px_rgba(0,0,0,0.08)] border border-border/20 overflow-hidden min-w-32">
